...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#efefef" :foreground "#333333"))))
 ...
 ;; '(font-lock-variable-name-face ((t (:foreground "DarkGoldenrod")))) ; original
 '(font-lock-variable-name-face ((t (:foreground "ForestGreen")))) ; custom
 '(font-lock-function-name-face ((t (:foreground "SlateBlue"))))
 ;; '(font-lock-builtin-face ((t (:foreground "ForestGreen")))) ; original
 '(font-lock-builtin-face ((t (:foreground "VioletRed")))) ; custom
 ;; '(highline-face ((t (:background "grey95")))) ; original
 '(highline-face ((t (:background "ForestGreen")))) ; original
 '(show-paren-match-face ((t (:background "grey80"))))
 ;; '(region ((t (:background "grey80")))) ; original
 '(region ((t (:background "beige")))) ; custom
