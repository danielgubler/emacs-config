...
;; (defvar dv-default-bg '("#2e3735" "#232a28")) ; original
;; (defvar dv-default-bg '("#1e2725" "#131a18")) ; custom 1
;; (defvar dv-default-bg '("#121918" "#121918")) ; custom 2
(defvar dv-default-bg '("#18201f" "#121918")) ; custom 3
(defvar dv-default-fg '("#b6beb4" "#a8b1a4"))
(defvar dv-cursor-bg '("#c73a7c" "#b0256c"))
(defvar dv-cursor-fg dv-default-bg)
;(defvar dv-region-bg '("#afc81c" "#a0c116")) ; original
(defvar dv-region-bg '("#c48337" "#c28136")) ; custom
...
(defvar dv-comment-fg '("#706a53" "#5c583f")) ; original
;; (defvar dv-comment-fg '("#66cc33" "#5c583f")) ; temp for display
(defvar dv-constant-fg '("#bebeb4" "#b1b1a4"))
;(defvar dv-function-fg dv-region-bg) ; original
(defvar dv-function-fg '("#afc81c" "#a0c116")) ; custom
;(defvar dv-mb-prompt-fg dv-region-bg) ; original
(defvar dv-mb-prompt-fg dv-function-fg) ; custom
