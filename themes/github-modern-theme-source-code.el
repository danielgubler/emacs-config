...
(defvar github-default-colors-alist
  '(("github-black"                  . "#000000")
    ...
    ;; ("github-constant"               . "#005cc5") ;; default
    ("github-constant"               . "#032f68") ;; custom
    ...
    ;; ("github-keyword"                . "#d73a49") ;; default
    ("github-keyword"                . "#996666") ;; custom

    ;; ("github-selection"              . "#3390ff") ;; default
    ;; ("github-selection"              . "#3399b6") ;; custom teal
    ("github-selection"              . "#cccccccc") ;; custom grey

    ("github-string"                 . "#032f62")
    ;; ("github-text"                   . "#24292e") ;; default
    ;; ("github-text"                   . "#a08f6c") ;; custom
    ("github-header"                   . "#24292e") ;; custom header
    ("github-text"                   . "#606066") ;; custom
    ("github-white"                  . "#ffffff"))
...
;;;;; org-mode
   ...
   ;; This is the default, which seems dumb...
   ...
   ;; custom
   `(org-level-1 ((t (:foreground ,github-header :weight bold))))
   `(org-level-2 ((t (:foreground ,github-header :weight bold))))
   `(org-level-3 ((t (:foreground ,github-header :weight bold))))
   `(org-level-4 ((t (:foreground ,github-header :weight bold))))
   `(org-level-5 ((t (:foreground ,github-header :weight bold))))
   `(org-level-6 ((t (:foreground ,github-header :weight bold))))
   `(org-level-7 ((t (:foreground ,github-header :weight bold))))
   `(org-level-8 ((t (:foreground ,github-header :weight bold))))

   `(org-link ((t (:foreground ,github-constant :underline t))))
